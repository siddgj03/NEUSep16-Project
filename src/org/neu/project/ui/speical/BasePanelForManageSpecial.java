 ...
 */
public class BasePanelForManageSpecial extends JPanel {
  ...
  public BasePanelForManageSpecial() {
    ...
    ComponetInitialize(discountValueOrPercentage, 1, 1, 1, 1, true);
  ...
  public static void main(String[] args) {
    BasePanelForManageSpecial a = new BasePanelForManageSpecial();
    a.setSize(700, 600);
    a.setVisible(true);
  }
}