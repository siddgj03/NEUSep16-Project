...
public class DealerBridge extends JFrame {
    ...
    public DealerBridge(String dealerName, String dealerID) {
    ...
    private void create() {
        ...
        labelofDealerName.setFont(new Font("Tohama", Font.BOLD, 20));
        
        ImageIcon image = new ImageIcon("/Users/xiaoyue/NEU_2016FALL__InformationSystem/INFO5100_JAVA/Assigments/finalProject/data/person.png");
        image.setImage(image.getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT));
        pic = new JLabel(image);
        pic.setPreferredSize(new Dimension(250, 250));
    ...
    private void add() {
        ...
        right.add(Box.createHorizontalStrut(3));
